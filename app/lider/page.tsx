              ...
              {step === 0 && (
                <div>
                  ...
                  <div className="flex flex-col items-center mb-8">
                    ...
                    <input id="foto-input-camera" type="file" accept="image/*" capture="environment" className="hidden" onChange={handleFotoChange} />
                    {fotoPreview ? (
                      ...
                      <div className="flex items-center gap-3 mt-1">
                        <button type="button" onClick={() => document.getElementById('foto-input-camera')?.click()}
                    ...
                    {!fotoPreview && (
                      <p className="text-xs text-slate-400 mt-1">JPG, PNG, WEBP o HEIC · Máx 5MB</p>
                    )}
                  </div>
